...
- Связанные US: 
[US-R2](../user-stories.md#us-r2-как-организатор-я-хочу-иметь-возможность-отредактировать-существующий-рецепт-чтобы-внести-улучшения-которые-выявились-позднее-создания-рецепта), 
[US-R3](../user-stories.md#us-r3-как-организатор-я-хочу-иметь-возможность-сохранить-отредактированный-рецепт-как-новый-чтобы-иметь-похожий-рецепт-но-с-другим-составом)
- Отмена редактирования не приводит к сохранению каких-либо изменений.

- Связанные FR:
- [FR-R2.3](../srs/3.%20Функции%20системы/3.1.%20Управление%20рецептами.md#fr-r23)
- [FR-R4.1](../srs/3.%20Функции%20системы/3.1.%20Управление%20рецептами.md#fr-r41)
- [FR-R4.5](../srs/3.%20Функции%20системы/3.1.%20Управление%20рецептами.md#fr-r45)
- [FR-R4.6](../srs/3.%20Функции%20системы/3.1.%20Управление%20рецептами.md#fr-r46)
- [FR-R4.10](../srs/3.%20Функции%20системы/3.1.%20Управление%20рецептами.md#fr-r410)
